...
namespace HW03_MVC.Controllers
{
    public class BMIController : Controller
    {
        ...
        // POST: BMI
        public ActionResult BMIComputePost()
        {
            return View();
        }

        [HttpPost]
        public async Task<ActionResult> BMIComputePost([Bind(Exclude = "result")] BMIViewModel bmidata)
        {
            string result = "", urlstring = "";
            ...
            try
            {
                urlstring = "http://140.137.41.136:5558/A6409001/HW03/api/BMIPost/" + bmidata.cm + "/" + bmidata.kg;

                //建立HttClient物件
                client = new HttpClient();
                // 將bmidata物件序列化成JSON格式字串
