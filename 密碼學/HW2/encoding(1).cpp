...
int main()
{
	fstream plaintext("C:\\Users\\user\\Desktop\\±K½X¾Ç\\HW2\\plaintext(1).txt", ios::in);
	fstream keySequence("C:\\Users\\user\\Desktop\\±K½X¾Ç\\HW2\\keySequence(1).txt", ios::in);
	fstream ciphertext("C:\\Users\\user\\Desktop\\±K½X¾Ç\\HW2\\ciphertext(3).txt", ios::out);
