...
public class ManageExpenseTypeActivity extends Activity
{
    ...
    public void onCreate(Bundle savedInstanceState)
    {
        ...
        try
        {
            ...
            {
                tvOutput.setText("目前並沒有建立任額消費種類!\n");
            }
    ...
    public void btnCreateNewExpenseType_Click(View v)
    {
        ...
        {
            Toast.makeText(this, "沒有填寫新消費種類!", Toast.LENGTH_LONG).show();
            empty++;
        }
        if (empty==0) // 若使用者有輸入新的消費種類，則進行以下處理
        {
            try //利用try{}包住可能會產生例外的處理程式碼(如存取資料庫及檔案)，讓程式即便有例外，也不會當掉，以增加app之強韌性
            {
                ...
                if(count==0) // 若傳回的資料筆數為0，表示新消費種類並不存在於目前資料表中，則可以將新的消費種類存入資料表中
                {
                    ...
                    Toast.makeText(this, "已新增【" + newExpenseTypeString + "】消費種類!", Toast.LENGTH_LONG).show();
                ...
                {
                    Toast.makeText(this, "該消費種類已經存在!", Toast.LENGTH_LONG).show();
                }
            }
    ...
    public void btnDeleteExpenseType_Click(View v)
    {
        ...
        {
            Toast.makeText(this, "沒有填寫消費種類編號!", Toast.LENGTH_LONG).show();
            empty++;
        }
        if (empty==0) // 使用者有輸入消費種類標號
        {
            try  //利用try{}包住可能會產生例外的處理程式碼(如存取資料庫及檔案)，讓程式即便有例外，也不會當掉，以增加app之強韌性
            {
                ...
                {
                    Toast.makeText(this, "消費種類編號超過範圍!", Toast.LENGTH_LONG).show();
                }
                else // 若消費種類編號在範圍內(大於等於1且小於等於紀錄筆數)
                {
                    ...
                    Toast.makeText(this, "已刪除【" + str2 + "消費種類!", Toast.LENGTH_LONG).show();
    ...
    public void btnDispalyExpenseTypes_Click(View v)
    {
        try
        {
            ...
            {
                tvOutput.setText("目前並沒有建立任何消費種類!\n");
            }
        }
        catch(Exception ex)
        {
