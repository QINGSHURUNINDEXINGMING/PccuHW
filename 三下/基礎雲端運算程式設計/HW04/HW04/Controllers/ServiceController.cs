...
namespace HW04.Controllers
{
    public class ServiceController : ApiController
    {
        ...
        ServiceModel1 db = new ServiceModel1();
        #endregion
        ...
        public ServiceController()
        {
            ...
            {
                // 預設的初始消費種類陣列
                string[] initialTypes = { "餐飲", "購物", "交通", "娛樂", "醫療", "投資", "保險", "教育", "社交", "住宿" };
                //建立消費種類紀錄物件
                HW04.Models.Type expType = new HW04.Models.Type();
                //建立ExpenseType型態的列舉物件(類似資料表)，可儲存消費種類紀錄
                IEnumerable<HW04.Models.Type> expenseTypes = db.ExpenseTypes;
