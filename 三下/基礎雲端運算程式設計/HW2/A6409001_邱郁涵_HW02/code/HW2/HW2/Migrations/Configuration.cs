        ...
        protected override void Seed(HW2.Models.Model1 context)
        {
            ...
            context.HWTBs.AddOrUpdate
                (
                    ...
                    new HWTB { name = "AAA", comment = "你好", date = DateTime.Parse("2019/4/28").Date },
                    new HWTB { name = "BBB", comment = "午安", date = DateTime.Parse("2019/4/28").Date },
                    new HWTB { name = "CCC", comment = "晚安", date = DateTime.Parse("2019/4/28").Date }
                );
        }
    }
}
